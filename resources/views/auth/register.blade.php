            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="datan" class="col-md-4 col-form-label text-md-right">{{ __('Data de Nascimento') }}</label>

                            <div class="col-md-6">
                                <input id="datan" type="date" class="form-control @error('datan') is-invalid @enderror" name="datan" value="{{ old('datan') }}" required autocomplete="datan" autofocus>
